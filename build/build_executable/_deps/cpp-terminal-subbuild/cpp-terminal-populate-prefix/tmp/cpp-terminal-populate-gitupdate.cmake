...
execute_process(
  COMMAND "/usr/bin/git" show-ref "80d1dd8"
  WORKING_DIRECTORY "/home/matthewalgo/Projects/picr/build/build_executable/_deps/cpp-terminal-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("80d1dd8" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/80d1dd8")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/matthewalgo/Projects/picr/build/build_executable/_deps/cpp-terminal-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/matthewalgo/Projects/picr/build/build_executable/_deps/cpp-terminal-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
